...
function Body() {
    ...
    return (
        <>
            <div className="relative w-full h-screen flex items-center justify-center"> {/* Full-screen height and width */}
                <video 
                    className="absolute top-0 left-0 w-full h-full object-cover opacity-80" // Ensure the video covers the full screen
                    autoPlay 
                    loop 
                    muted
                    src="/GhumteHaii/body-bg.mp4" // Update the path to include the repository name
                />
                ...
                <div className="hero-content text-neutral-content text-center relative z-10"> {/* Centered content */}
                    <div className="w-full text-orange-50 p-6">
